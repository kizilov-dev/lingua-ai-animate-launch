      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {reviews.map((review, i) => (
            ...
            >
              <img src={avatars[i]} alt={review.name} className="w-20 h-20 rounded-full object-cover mb-4 border-4 border-primary" />
              <blockquote className="italic text-muted-foreground text-lg mb-4 text-center">&ldquo;{review.text}&rdquo;</blockquote>
